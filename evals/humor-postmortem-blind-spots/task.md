...
```bash
curl -sLO https://github.com/jbaruch/speaker-toolkit/raw/main/eval-resources/humor-postmortem-blind-spots/test_analysis_recent.json
curl -sLO https://github.com/jbaruch/speaker-toolkit/raw/main/eval-resources/humor-postmortem-blind-spots/test_analysis_old.json
```
