...
**Important:** Sam has specific war stories, data points, and meme preferences she wants to insert herself. Where her input is needed, use placeholder markers so she knows where to fill in her own content. She also wants callback opportunities flagged explicitly so she can track the throughline during rehearsal.
