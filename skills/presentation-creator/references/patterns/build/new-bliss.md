...
- Future-tense imagery describing the world after adoption ("imagine…", "you'll see…", "the day will come when…")
- Concrete scenes rather than abstract states
- Emotional register that elevates the closing rather than continuing the persuasive argument
- Position: between the imperative asks and the talk's final words (often before "thank you")
- Brevity: typically 30 seconds to 2 minutes of speaking time
...
## Related Reading
- Duarte, N. (2010). *Resonate: Present Visual Stories that Transform Audiences.* Ch. 2, 4 — New Bliss as the sparkline's terminal element; the principle-of-recency justification for placing it last; case-study examples (JFK's moon speech, MLK's "I Have a Dream") that demonstrate vivid future-state visions matched to humanity-scale change. Wiley.
