...
## Related Reading
- Reynolds, G. (2012). *Presentation Zen.* Ch. 7, 11 — visual storytelling and the use of imagery to compress meaning. New Riders.
- Duarte, N. (2010). *Resonate.* Ch. 5 — the use of pop-culture references to bridge the speaker's argument to the audience's existing mental models. Wiley.
