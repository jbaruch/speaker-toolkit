...
detection_signals:
  ...
  - "voice-over slides recording"
related_patterns: [lipsync, entertainment]
inverse_of: []
...
## Scoring Criteria
- Strong signal: High-quality recorded version of the full talk available, with clear audio, visible slides, and optionally picture-in-picture video of the presenter, distributed through accessible channels
- Moderate signal: Recording exists but with quality issues (poor audio, missing slides, incomplete capture) or limited distribution
- Absent: No recorded version available, or only a PDF/static export of slides distributed without narration

## Vault Observability
The ingested recording is evidence that ingress acquired a video, not that the speaker
created and distributed a separate published recording through accessible channels. Treating
the input itself as proof would make every video-ingested talk tautologically positive and
every non-video talk falsely absent. Keep this as a publishing checklist until an independent
