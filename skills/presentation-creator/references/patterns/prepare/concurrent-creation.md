...
For individual speakers, Concurrent Creation means giving yourself permission to jump around. If you wake up with a brilliant idea for your conclusion, write it now — do not wait until you have finished the introduction. If a perfect example for section four comes to mind while you are working on section two, capture it immediately. The key is maintaining awareness of your overall Narrative Arc so that the pieces fit together when assembled. Creating out of order forces you to verify your arc repeatedly — each time you add a piece, check that it connects to the whole.
