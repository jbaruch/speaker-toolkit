...
### Murder Your Darlings — The Pre-Delivery Cut Pass
...
- Duarte, N. (2010). *Resonate: Present Visual Stories that Transform Audiences.* Ch. 5, 8 — *Murder Your Darlings* (Quiller-Couch) as the convergent-thinking filter pass after divergent generation; Markus Covert's Pioneer Award case study (20 rehearsals with cross-discipline scientists) and Leonard Bernstein's Young People's Concerts (10 script revisions per show) as exemplars of iterative refinement. Wiley.
