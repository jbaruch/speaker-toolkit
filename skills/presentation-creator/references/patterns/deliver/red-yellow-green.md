...
## Scoring Criteria
- Strong signal: Structured, low-barrier feedback mechanism in place, evidence that feedback is collected and acted upon across deliveries
- Moderate signal: Some feedback collection but using higher-barrier methods (online surveys, written forms) with lower participation rates
- Absent: No feedback mechanism beyond whatever the conference provides by default
