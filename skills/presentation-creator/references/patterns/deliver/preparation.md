...
vault_dimensions: [14]
detection_signals:
  - "equipment backup mentioned"
  - "preparation checklist evident"
  - "contingency plans visible"
related_patterns: [know-your-audience, carnegie-hall]
inverse_of: []
...
## Combinatorics
Preparation is the foundational pattern that enables all other delivery patterns. It pairs naturally with Carnegie Hall (rehearsal is a form of preparation) and Know Your Audience (research is preparation for content calibration). It also supports Stakeout (early venue arrival) and Shoeless (comfort preparation). Without Preparation, patterns like Weatherman and Make It Rain become risky. They depend on equipment and props that may fail.
